        ...
        this._mapsWrapper.getNativeMap().then(function (map) {
            ...
            clusterer.setCalculator((markers, count) => {
                if (markers.length > 1) {
                    ...
                    return {
                        text: "<small style='color:#f96363;font-size:0.7rem;text-align:center;background: white;padding: 0.4rem 0.6rem;border-radius: 16px;box-shadow: rgba(0, 0, 0, 0.26) 0px 0px 8px;font-weight: 700;font-family:" + 'Lato' + ",sans-serif;'>" + price + "</small> <p style='padding-left:0;padding-top:2px;font-size:22px;position: relative;top: 0;font-family:" + 'Lato' + ",sans-serif;margin-top: 0.3rem;'>" + markers.length + "</p><p style='padding-left: 0;padding-top: 9px;font-size: 0.7rem;position: relative;bottom: 35%;font-family: Lato,sans-serif;'>Proyectos</p>",
                        index: index
                    }
                }
